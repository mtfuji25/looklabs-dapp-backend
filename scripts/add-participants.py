...
def run():
    try:
        for i in range(100):
            os.system("curl -X POST -H 'content-type: application/json' -H 'Authorization: bearer " + args.auth + "' https://the-pit-cloud-3fiy6wgliq-nw.a.run.app/api/scheduled-game-participants -d '{ \"data\": { \"nft_id\": \"e3afc60c-a846-4b4e-bf19-6656d6fb8e8" + str(i) + "/" + str(i) + "\", \"user_address\": \"0xb960d6b39023cec0e9c22bcf43e46705b5ddb572\", \"name\": \"\", \"image_address\": \"\", \"scheduled_game\": " + str(args.game) +" } }'")
