...
// Components imports
import { Rectangle } from "../Core/Ecs/Components/Rectangle";
import { Rigidbody } from "../Core/Ecs/Components/Rigidbody";
...
const rayIntersectRec = (rayOrigin: Vec2, rayDir: Vec2, recTarget: Rectangle, results: CollisionResult) => {
...
const recIntersectRec = (a: Rigidbody, b: Rigidbody, deltaTime: number, results: CollisionResult) => {
...
const recIntersectStatic = (a: Rigidbody, b: Rectangle, deltaTime: number, results: CollisionResult) => {
