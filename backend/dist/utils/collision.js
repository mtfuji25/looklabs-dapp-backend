...
var recIntersectRec = function (a, b, deltaTime, results) {
    ...
    var expanded = new rectangle_1.RectangleComponent(b.rectangle.width + a.rectangle.width, b.rectangle.height + a.rectangle.height, b.rectangle.transform);
...
var recIntersectStatic = function (a, b, deltaTime, results) {
    ...
    if (a.velocity.x == 0 && a.velocity.y == 0)
        return false;
    // Expanded target rectangle
    var expanded = new rectangle_1.RectangleComponent(b.width + a.rectangle.width, b.height + a.rectangle.height, b.transform);
    // Direction vector of origin rectangle
