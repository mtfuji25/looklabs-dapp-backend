...
var MapColliderLayer = /** @class */ (function (_super) {
    ...
    function MapColliderLayer(ecs) {
        var _this = _super.call(this, "MapCollider", ecs) || this;
        _this.self.addGrid(LevelCollider_json_1.default["width"], LevelCollider_json_1.default["height"]);
        _this.self.addRectangle();
        return _this;
    }
    MapColliderLayer.prototype.onAttach = function () {
        var grid = this.self.getGrid();
        for (var i = 0; i < LevelCollider_json_1.default["width"]; ++i) {
            for (var j = 0; j < LevelCollider_json_1.default["height"]; ++j) {
                var collider = LevelCollider_json_1.default["data"][i][j];
                if (collider !== 0) {
                    grid.addStatic(j, i);
                }
            }
